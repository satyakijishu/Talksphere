...
function AssistantModeSelector() {
    ...
    return (
        <>
            ...
            {/* ✅ Video Background */}
            <div className="relative w-full min-h-[100vh] flex flex-col items-center justify-between">
                <video
                    autoPlay
                    loop
                    muted
                ...
                {/* ✅ Main Content */}
                <div className="relative z-10 flex flex-col items-center pt-10 w-full">
                    
                    {/* ✅ Avatar & Assistant Name */}
                    <div className="flex flex-col items-center mb-10">
                        <div className="w-[120px] h-[120px] rounded-full overflow-hidden border-4 border-blue-500 shadow-lg mb-3">
                            <img
                    ...
                    {/* ✅ Options Container */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-[900px] px-6 mb-10">
                        
                        {/* ✅ Chat Mode Button */}
                        <div
                            onClick={() => navigate("/assistance")}
                            className="cursor-pointer group relative bg-white/10 border border-white/20 rounded-3xl shadow-lg p-10 flex flex-col items-center text-center
